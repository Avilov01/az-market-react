...
export const Card = ({ name, imageUrl, price }) => {
	return (
		<div className='border border-opacity-80 p-5 rounded-3xl w-64 hover:shadow-2xl hover:-translate-y-2 transition duration-300 transform ease-in-out hover:border-opacity-50'>
